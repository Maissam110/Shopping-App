...
import 'package:e_comerence_app/features/my%20orders/repository/order_repository.dart';
import 'package:e_comerence_app/features/my%20orders/view/widget/order_card.dart';
  ...
  Widget _buildOrderList(BuildContext context, OrderStatus status) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) =>
          OrderCard(onViewDetails: () {}, order: orders[index]),
    );
  }
}
